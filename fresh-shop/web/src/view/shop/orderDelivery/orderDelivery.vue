    ...
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline" @keyup.enter="onSubmit">
        <el-form-item label="预计到达时间">
          ...
          <el-date-picker v-model="searchInfo.startScheduledTime" type="datetime" placeholder="搜索条件（起）" />
          —
          <el-date-picker v-model="searchInfo.endScheduledTime" type="datetime" placeholder="搜索条件（止）" />
        ...
        <el-form-item label="收货时间">
          ...
          <el-date-picker v-model="searchInfo.startReceiptTime" type="datetime" placeholder="搜索条件（起）" />
          —
          <el-date-picker v-model="searchInfo.endReceiptTime" type="datetime" placeholder="搜索条件（止）" />
