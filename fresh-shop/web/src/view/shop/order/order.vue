    ...
    <div class="gva-search-box">
      <el-form :inline="true" :model="searchInfo" class="demo-form-inline" @keyup.enter="onSubmit">
        ...
        <el-form-item label="收货时间">
            ...
            <el-date-picker v-model="searchInfo.startReceiveTime" type="datetime" placeholder="搜索条件（起）"></el-date-picker>
            —
            <el-date-picker v-model="searchInfo.endReceiveTime" type="datetime" placeholder="搜索条件（止）"></el-date-picker>

        </el-form-item>
        <el-form-item label="取消时间">
            
            <el-date-picker v-model="searchInfo.startCancelTime" type="datetime" placeholder="搜索条件（起）"></el-date-picker>
            —
            <el-date-picker v-model="searchInfo.endCancelTime" type="datetime" placeholder="搜索条件（止）"></el-date-picker>
