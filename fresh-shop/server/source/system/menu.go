...
func (i *initMenu) InitializeData(ctx context.Context) (next context.Context, err error) {
	...
	entities := []SysBaseMenu{
		...
		{MenuLevel: 0, Hidden: false, ParentId: "0", Path: "file", Name: "file", Component: "view/file/index.vue", Sort: 7, Meta: Meta{Title: "媒体库", Icon: "management"}},
		{MenuLevel: 0, Hidden: false, ParentId: "12", Path: "upload", Name: "upload", Component: "view/file/upload/upload.vue", Sort: 5, Meta: Meta{Title: "图片媒体", Icon: "upload"}},
		{MenuLevel: 0, Hidden: false, ParentId: "12", Path: "breakpoint", Name: "breakpoint", Component: "view/file/breakpoint/breakpoint.vue", Sort: 6, Meta: Meta{Title: "断点续传", Icon: "upload-filled"}},
