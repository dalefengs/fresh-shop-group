...
func RegisterTables() {
	...
	err := db.AutoMigrate(
		...
		example.ExaFileUploadAndDownload{}, account.SysRecharge{}, account.UserFinanceType{}, account.UserFinance{}, business.Banner{}, shop.Category{}, shop.Brand{}, shop.BrandCategory{},
	)
	if err != nil {
